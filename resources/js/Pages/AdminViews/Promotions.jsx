    ...
    const promotions = [
        {
            ...
            endDate: '20/06/2004',
            edit: <button
                className="text-blue-500 hover:text-white hover:bg-blue-500 px-3 py-1 rounded-full border border-blue-500 transition duration-200">Edit</button>,
        },
        {
...
Promotions.layout = (page) => <Layout children={page} type={'admin'}/>;
